    ...
    <div className="w-full bg-[#f7d7d7b2] py-24 dark:bg-[#FF204E]">
      <div className="md:max-w-[1480px] m-auto  max-w-[600px]  px-4 md:px-0 ">
        <h1 className="md:leading-[72px] text-3xl font-bold ml-4 dark:text-black">
          Most{" "}
          <span className="text-[#FF204E] dark:text-white">
            Popular Categories
          </span>
        </h1>
        <p className="text-lg text-gray-900 ml-4">
        ...
        <div className="grid lg:grid-cols-4 grid-cols-2 py-12 md:gap-4 gap-1 m-4">
          ...
          <CategoryCard icons={<TiHtml5 size={30} />} title={"Softskills"} />
          <CategoryCard icons={<TiHtml5 size={30} />} title={"Fitness"} />
