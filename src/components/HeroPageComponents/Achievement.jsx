...
import { achievement } from "../../assets/HeroPageAssets";
  ...
  return (
    <div className="md:max-w-[1480px] m-auto grid md:grid-cols-2 max-w-[600px]  px-4 md:px-0 ">
      <div className="flex flex-col justify-center ">
        ...
        <div className="grid grid-cols-1 dark:text-white  md:grid-cols-2 md:bg-whites">
      ...
      <img
        src={achievement}
        className="m-auto  md:order-last  order-first mr-12"
      />
    </div>
  );
};
